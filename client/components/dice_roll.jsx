...
// bankruptcy button - allowing a user to go 'bankrupt' or leave the game at any point;

// check if all of a user\'s properties are mortgaged
  // if so, check if the user owes rent
    // if so, check if the amount owed < the user's current money
      // if so, pay the propertyOwner the rent owed
        // set the user's properties to empty
        // set the user's 'bankrupt' state to true
        // set the user's cash to 0
      // if not, pay the propertyOwner all of the user's cash
        // set the user's properties to empty
        // set the user's 'bankrupt' state to true
        // set the user's cash to 0
    // if not,
      ...
      // set the user's 'bankrupt' state to true
      // set the user's cash to 0
  // if not, do not let the user go bankrupt